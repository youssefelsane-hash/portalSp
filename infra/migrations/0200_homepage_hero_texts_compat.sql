-- baytak — 0200: مفاتيح توافق لنصوص واجهة الـhero (docs/08 §64.د، طلب مالك صريح 2026-08-26)
--
...
-- إعدادات عادية بـ is_public=true، صفر جدول جديد وصفر endpoint جديد. مصدر الحقيقة الحالي هو
-- homepage.search_content (0197)؛ المفاتيح دي باقية لتوافق أي عميل خرج من فرع Claude قبل الدمج.
--
