        ...
        items: [
          {
            ...
            // التبرير إجباري (ADR-0084 §2، ١٠ حروف على الأقل) — التدقيق ده اتكتب قبل القاعدة دي
            // وكان بيقع على 400 «البيانات المرسلة غير صحيحة» قبل ما يقيس أي حاجة.
            description: 'قطعة غيار لازمة لإكمال إعادة الزيارة — بند تدقيق حي لمسار العمولة',
            quantity: 1,
