...
@Module({
  ...
  controllers: [BookingPolicyController, SupportContactController, HomepageContentController, TrustInfoController, LegalEntityController, SocialLinksController],
