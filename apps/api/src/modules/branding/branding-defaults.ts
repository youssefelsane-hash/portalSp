...
const DEFAULT_MARK = svgDataUri(
  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><path d="${MARK_PATH}" fill="#153f38" fill-rule="evenodd"/></svg>`,
);

const DEFAULT_LOGO = svgDataUri(
  `<svg xmlns="http://www.w3.org/2000/svg" width="280" height="80" viewBox="0 0 280 80"><g transform="translate(6 2) scale(.76)"><path d="${MARK_PATH}" fill="#153f38" fill-rule="evenodd"/></g><text x="92" y="57" font-family="Avenir Next,Montserrat,sans-serif" font-size="52" font-weight="700" letter-spacing="3" fill="#17211f">OSTA</text></svg>`,
);
...
export const DEFAULT_BRANDING_ASSETS: Record<BrandingAssetType, DefaultBrandingAsset> = {
  ...
  [BrandingAssetType.SPLASH]: {
    url: placeholderSvgDataUri('OSTA', '#153F38', '#F7F2E8'),
    width_px: 240,
    height_px: 80,
  },
};
