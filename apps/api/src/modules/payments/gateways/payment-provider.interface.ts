...
export type CreatePaymentResult =
  ...
  | {
      ...
      /**
       * **الحساب اللي العميل هيحوّل عليه — حقل مستقل مش جوّه نص التعليمات** (طلب مالك
       * 2026-09-11: «يبقى رقم التليفون مكتوب جوه بوضوح سطر لوحده كده عشان ما تتدخلش العربي
       * مع الإنجليزي»).
       *
       * لما الرقم بييجي مدفون وسط جملة عربية، الـbidi بيقلب ترتيب خاناته على الشاشة والعميل
       * بينسخه غلط أو يكتبه غلط — وده تحويل بنكي بيروح لحساب تاني. الفصل هنا هو اللي بيخلّي
       * الواجهة تقدر تعرضه LTR في سطر لوحده مع زرار نسخ.
       */
      recipientAddress?: string | null;
      recipientName?: string | null;
      /** المبلغ المطلوب تحويله — الواجهة بتعرضه منسّق بدل ما تستخرجه من النص. */
      amountCents?: number;
      /** وعد وقت التأكيد للعميل: المعتاد والحد الأقصى بالدقايق. */
