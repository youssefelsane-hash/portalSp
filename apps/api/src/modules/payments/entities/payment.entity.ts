...
export class Payment {
  ...
  // كان ممكن يبقى NULL لو الدفعة لحجز خدمة منزلية (بنية منفصلة اتلغت، ADR-0031) — العمود لسه
  // nullable في الـDB (تفاديًا لمخاطرة migration NOT NULL تحت ضغط وقت)، بس دايمًا موجود عمليًا الآن.
