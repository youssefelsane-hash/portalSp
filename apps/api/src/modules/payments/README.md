...
> ⚠️ الأثر العملي إن عدّاد المطابقة في لوحة الأدمن على بيئة التطوير بيفضل موجب دايمًا، وده
> بيعوّد الناس تتجاهله — وهو بالظبط العدّاد المفروض يمسك كسر حقيقي. تنضيف السبيكات دي (حذف
> الحركات **مع** إعادة مزامنة أرصدة المحافظ المتأثرة) مسجّل كمهمة مستقلة.
