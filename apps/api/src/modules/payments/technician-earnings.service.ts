...
/**
 * سطر شغلانة واحدة في نموذج المطابقة المالي الداخلي. كل الأرقام قروش.
 *
 * النموذج الكامل مخصص للأدمن والتقارير والمطابقة المحاسبية. واجهة الفني العامة تمر عبر
 * `TechnicianPaymentsController` الذي يرجع حصته والكاش والاسترداد والصافي فقط، ولا يكشف
 * إجمالي الطلب أو خصم العميل أو عمولة المنصة.
 */
...
/**
 * نموذج كشف مستحقات الفني الشهري الداخلي (ADR-0038، docs/08 §61.1).
 *
