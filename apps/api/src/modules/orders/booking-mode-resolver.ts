 ...
 * البث الفوري لطلب بلا تاريخ مضمون من مكان تاني خالص (`computeDispatchDeferredUntil` بترجّع
 * `undefined` لـ`scheduledAt = null`) — يعني مفيش تأخير، بس كمان مفيش رسوم ولا بوابة.
 *
