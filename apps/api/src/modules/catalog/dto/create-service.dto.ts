...
export class CreateServiceDto {
  ...
  // هو يروح لفنيين فقط، بيروح لأحسن فني»). false (الافتراضي) = قاعدة ADR-0055 العادية —
  // المساعد المؤهّل بياخد الطلب كقائد. بيسري على التوزيع العام والترشيح داخل الشركة بنفس الحرف.
  @IsOptional()
  @IsBoolean()
