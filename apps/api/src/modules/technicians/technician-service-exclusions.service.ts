 ...
 * بيحجب اللي يختاره عن **قيادة الطلب مباشرة**. للمساعد، اعتماد التخصص يظل كافيًا للانضمام عضوًا
 * في طاقم حتى لو كل خدمات القيادة محجوبة. الفرض الفعلي موجود في دالتي الأهلية المنفصلتين في
 * `technician-eligibility.sql.ts`؛ الخدمة دي تدير البيانات وتعرضها للأدمن فقط.
 */
@Injectable()
