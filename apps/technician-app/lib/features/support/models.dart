// فئات الشكوى (§24 — نفس ComplaintCategory في apps/customer-app/lib/features/support/models.dart
// بالحرف، مطابقة لـ apps/api/src/modules/support/entities/complaint.entity.ts).
...
const Map<String, String> complaintStatusLabelsAr = {
  ...
  'awaiting_technician': 'مستنية ردّك',
  'resolved': 'اتحلّت',
  'rejected': 'مرفوضة',
  'escalated': 'مُصعَّدة',
  'closed': 'مقفولة',
