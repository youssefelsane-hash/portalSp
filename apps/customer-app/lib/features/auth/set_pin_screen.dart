...
///
/// وضعان:
///  - `SetPinMode.migration` — مستخدم **داخل بالفعل** من قبل التبديل ومالوش رمز. الشاشة
///    **مالهاش مخرج**: من غير رمز الحساب ده مالوش أي credential خالص، فأول ما الجلسة تنتهي
///    (تسجيل خروج، جهاز جديد، توكن ملغي) المستخدم يبقى مقفول برّه حسابه ومحتاج استرجاع من
///    الأدمن. شاشة واحدة مرة واحدة أرخص من تذكرة دعم لكل مستخدم.
                    ...
                    Text(
                      _isMigration
                          ? 'بقيت تدخل بالرمز ده بدل كود الرسايل — أسرع وما بيحتاجش انتظار. '
                                'خزّنه في مكان تفتكره: هو اللي هيرجّعك لحسابك لو سجّلت خروج أو '
                                'غيّرت موبايلك.'
