          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // **النص اتغيّر بطلب المالك** (2026-09-16، docs/08 §152):
                //
                // القديم كان «فريق كامل بيقدر يغطّي الشغل الكبير، ومسؤولية الشغل على الشركة
                // نفسها» — وفيه غلطتين:
                //  1. «الشغل الكبير» **مش صح**: الشركة بتغطّي كل أنواع الشغل، مش الكبير بس.
                //     النص كان بيضيّق عرضها ويخلّي العميل يستبعدها لشغلانة عادية.
                //  2. «مسؤولية الشغل على الشركة نفسها» كلام تعاقدي/داخلي مالوش مكان في كارت
                //     اختيار — المالك طلب صراحةً ما نكتبش عن المسؤولية لا بالإيجاب ولا بالنفي.
                Text(
                  'فريق كامل من المتخصصين، بيغطّي كل أنواع الشغل.',
                  style: TextStyle(
                    fontSize: 12,
