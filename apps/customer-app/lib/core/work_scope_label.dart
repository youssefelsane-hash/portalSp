...
///
/// القاعدة: **الدقايق أدق فبتكسب لما تكون موجودة**؛ يوم العمل التشغيلي = 10 ساعات، وأي عمل
/// يتجاوزها يُعرض بعدد أيام العمل المقربة للأعلى حتى لا يَظهر "يوم و6 ساعات" كموعد مضلل.
...
String? formatWorkDuration({int? minutes, num? days}) {
  if (minutes != null && minutes > 0) {
    ...
    if (minutes > _workDayMinutes) return _daysLabel((minutes / _workDayMinutes).ceil());
