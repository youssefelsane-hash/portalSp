...
class BiometricAuthService {
  ...
  static Future<bool> isEnabled() async {
    // Desktop is an explicit local testing target. Login still goes through the backend, but a
    // mobile biometric preference must never lock the native laptop build.
