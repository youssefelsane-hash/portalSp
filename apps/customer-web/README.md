...
- **"نصايح مفيدة"** (أسفل "كل الفئات") — قسم كروت أفقي قابل للتمرير (تصميم مرجعي: "Popular cost
  guides" في Angi.com). **placeholder بصري بس عمدًا** (`HOME_TIPS` في `page.tsx`) — 3 كروت بمحتوى
  نصي مبدئي، صفر نظام مقالات/CMS حقيقي (مش مطلوب، طلب مالك صريح: "ما تبذلش مجهود كتير"). صفر رابط
  "اقرأ أكتر" فعلي عمدًا — مفيش صفحة مقال حقيقية يودّي لها لسه، الكروت معلوماتية بس مش تفاعلية.
