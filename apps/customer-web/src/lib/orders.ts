...
export interface CreateOrderBody {
  ...
  /**
   * إعادة زيارة تحت الضمان (ADR-0051) — الباك-إند بيصفّر السعر وبيرجّع الطلب لنفس الفني الأصلي.
   * مفيش endpoint منفصل لإعادة الزيارة عمدًا: هي طلب عادي بالحرف + الحقل ده.
   */
