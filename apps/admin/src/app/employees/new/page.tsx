  ...
  return (
    <AppShell>
      <OneTimeCodeDialog
        ...
        description={
          <>
            الحساب اتعمل، بس الموظف <b>لسه مالوش رمز دخول</b>. ابعتله الكود ده دلوقتي — بيفتح
            <b>لوحة التحكم ← تفعيل الحساب</b> (<code>/activate</code>)، يكتب رقمه والكود، ويختار رمز
            دخوله بنفسه. صالح ١٥ دقيقة ولمرة واحدة، ومش هتقدر تشوفه تاني. لو ضاع، تقدر تصدر واحد
            جديد من صفحة الموظف.
          </>
        }
