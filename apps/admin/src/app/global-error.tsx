...
/**
 * **آخر شبكة أمان للوحة الأدمن** (ADR-0114): عطل في الـlayout نفسه، قبل ما أي CSS يتحمّل.
 *
...
export default function GlobalError({ error, retry }: { error: Error & { digest?: string }; retry: () => void }) {
  ...
  return (
    <html lang="ar" dir="rtl">
      ...
      <title>حصلت مشكلة — لوحة أسطى</title>
      <body
        style={{
          margin: 0,
          minHeight: '100vh',
      ...
      >
        <div style={{ maxWidth: '32rem', padding: '1.5rem', textAlign: 'center' }}>
          ...
          <p style={{ marginTop: '0.75rem', fontSize: '0.95rem', lineHeight: 1.8, color: '#4b5563' }}>
            مقدرناش نفتح اللوحة دلوقتي. جرّب تحدّث الصفحة بعد لحظة.
          </p>
          <button
            type="button"
            onClick={retry}
