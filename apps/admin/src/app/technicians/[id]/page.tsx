      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-3 text-sm">
            ...
            <p className="text-muted-foreground">
              الفني الكامل يمكنه قيادة الطلبات التي اعتمدها الأدمن. المساعد <strong>لا يستلم طلبًا
              كقائد</strong> ولا يظهر للعميل كمقدم خدمة منفرد؛ يظهر للفنيين داخل قائمة المساعدين
              في تخصصاته المعتمدة، وترتيبه يعتمد على المسافة وجودة المطابقة.
            </p>
            <p className="text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-4 text-sm text-muted-foreground">
              {detail.technician_kind === 'assistant' ? (
                <>
                  الحجب هنا يمنع المساعد من استلام الشغلانة <strong>كقائد بمفرده</strong>. يظل
                  ظاهرًا للمساعدة داخل تخصصه المعتمد؛ لإيقاف ذلك ألغِ اعتماد التخصص نفسه.
                </>
              ) : (
                <>
