      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-3 text-sm">
            ...
            {/* ADR-0087 (تصحيح مالك، يلغي ADR-0086) — النص ده كان بيقول إن المساعد «لا يستلم
                طلبًا كقائد» أبدًا. القاعدة دي اتلغت: المفتاح هو الحجب مش النوع. وصف غلط في شاشة
                الأدمن بيخلّي القرارات تتاخد على أساس فاهم غلط. */}
            <p className="text-muted-foreground">
              الدورين بياخدوا <strong>نفس المعاملة بالظبط</strong>: الاتنين بياخدوا طلبات لوحدهم،
              بيظهروا للعملاء في قايمة الاختيار وفي الترتيب، بيتوزّعلهم شغل تلقائي، والأدمن يقدر
              يعيّنهم يدويًا — <strong>طالما الخدمة مش محجوبة عنهم</strong> من كارت «الشغلانات
              المسموح بيها» تحت.
              <br />
              <strong>الفرقان الوحيدان</strong>: (١) الخدمة المحجوبة عن المساعد بيفضل يقدر
              <strong> يساعد</strong> فيها داخل طاقم حد تاني، بس <strong>مايقودهاش</strong>.
              (٢) لما ينضم لطاقم شغلانة فني تاني بياخد <strong>تسعيرة المساعد</strong> (أجر الخدمة
              × معامل مستواه)؛ ولما يشيل طلب لوحده بياخد نصيب القائد كامل زي أي حد عمل الشغلانة كلها.
            </p>
            <p className="text-muted-foreground">
