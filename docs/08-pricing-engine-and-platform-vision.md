...
**🔄 قيد التنفيذ (2026-08-13، قرار عمل صريح من المالك)**: المالك حدد آلية auto-matching بالتفصيل — أولوية 1: المساعد الشخصي المعتمد المرتبط بالفني القائد (`TechnicianAssistantLinkStatus.approved` الموجود من قبل) لو متاح وملوش تعارض مواعيد. أولوية 2: لو مفيش مساعد شخصي متاح، بث الفرصة لمجمع المساعدين المؤهلين عبر آليات الإشعار/اللحظي الموجودة، وأول قبول صحيح ياخد الفرصة (concurrency-safe/atomic — لازم يبقى فايز واحد بس لو اتنين قبلوا في نفس اللحظة تقريبًا)، وبمجرد اكتمال كل الأماكن المطلوبة الفرصة تتقفل فورًا لباقي المساعدين. لو معدية المهلة المحددة بدون قبول → تصعيد للعمليات/الأدمن. عدد المساعدين المطلوب بييجي من `ServiceStandardData.minAssistants`/§1 (`required_assistants` على الطلب) — لو صفر، آلية المطابقة دي مابتبدأش خالص. **ده subsystem جديد فعليًا (مش وصلة زي §1/§3) — قرار التصميم موثّق في `docs/adr/0007-assistant-pool-matching.md` قبل التنفيذ.**
