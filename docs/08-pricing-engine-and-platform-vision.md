...
15. **محرك إشعارات حقيقي (أولوية/تكرار/reminders مُدارة من الباك-إند)** — طلب صريح جديد من المالك (2026-08-13)، تفاصيل §15 الجديد تحت. **⬜ فاضي بالكامل.**
...
## §14. ترقية أمان دخول الأدمن — Passkeys/WebAuthn + MFA + Step-up Authentication — ⬜ فاضي بالكامل (طلب صريح 2026-08-13)
...
**لسه محتاج قرار عمل صريح من المالك قبل البدء الفعلي**: هل نبدأ بـSuper Admin بس (أضيق نطاق، أسرع تسليم) وبعدين نوسّع لباقي الأدوار الحساسة، ولا الاتنين مع بعض من الأول؟ التوصية المبدئية: Super Admin أولاً (Phase 1)، باقي الأدوار الحساسة (Finance وغيرها اللي عندها `roles.manage`/`payouts.approve`) Phase 2 بعد ما Phase 1 يثبت.

---

## §15. محرك إشعارات حقيقي — أولوية/تكرار مُدار من الباك-إند — ⬜ فاضي بالكامل (طلب صريح 2026-08-13)
