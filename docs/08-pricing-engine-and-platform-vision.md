...
15. **محرك إشعارات حقيقي (أولوية/تكرار/reminders مُدارة من الباك-إند)** — طلب صريح جديد من المالك (2026-08-13)، تفاصيل §15 الجديد تحت. **🔄 الأساس العام + action_required + scheduled_job خلصوا، critical_offer actionable push وواجهة الأدمن لسه فاضيين.**
...
## §15. محرك إشعارات حقيقي — أولوية/تكرار مُدار من الباك-إند — 🔄 الأساس + action_required + scheduled_job خلصوا (2026-08-13/14، فرع `hgotr7`)، critical_offer/واجهة الأدمن فاضيين (طلب صريح 2026-08-13)
