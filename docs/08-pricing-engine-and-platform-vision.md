...
1. **محرك التسعير الديناميكي (Pricing Engine)** — "أهم حاجة"، أساس كل حاجة تانية (المدة/الطاقم/الجدولة كلهم محتاجين السعر يتحسب صح الأول)
...
## §1. محرك التسعير الديناميكي (Pricing Engine) — 🔄 التصميم بدأ، التنفيذ لسه
