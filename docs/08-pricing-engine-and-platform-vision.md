...
2. تدقيق قصير: هل `admin-orders.service.ts`'s منطق ترشيح فنيين للتعيين اليدوي/إعادة التعيين بيستخدم
   نفس `MatchingService`'s معايير الأهلية بالظبط (فئة/منطقة/يوم محظور) — طلب مالك صريح (بند 15/28.3.8).
