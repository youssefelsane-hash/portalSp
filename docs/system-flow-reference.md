...
العمارة مش نسختها (§125). وكود الخصم (البرومو) **مابيتكررش** — استخدام لمرة واحدة بالتصميم.
...
**الرموز**: ✅ مطبّق ومربوط · ❌ فجوة موثّقة (تفاصيلها في `docs/08` §126/§128) · — مش منطبق
...
| أسماء أزرار الإشعار قابلة للتخصيص على أندرويد وثابتة على iOS | قيد منصة — iOS بيسجّل الفئات وقت الإقلاع (§127) |
| قائمة الخطط المتكررة في تطبيق العميل مبسّطة | مفيش احتياج عرض للتفاصيل هناك (§125) |
| الصوت المخصص للإشعارات مش مفعّل | مفيش ملفات صوت متبنّية أصلاً في التطبيقين (§127) |
