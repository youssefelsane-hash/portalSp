...
**الحالة:** مستبدَل بـ ADR-0031 (2026-08-21) — طلب مالك صريح: الشغالة/المربية مش نوع مستخدم/كيان
مستقل، لازم تبقى فني عادي بنفس مسار التسجيل/الاعتماد/الكتالوج. القرار هنا (كيان مستقل تمامًا)
كان غلط معماريًا من الأساس، مش تفصيل يتظبط — راجع ADR-0031 لخطة الإلغاء الكاملة.
**التاريخ:** 2026-08-12
