...
**الحالة:** مستبدَل بـ ADR-0031 (2026-08-21) — الخطة هنا كانت قايمة على نقل `DomesticWorkerProfile`
(كيان منفصل) للمحرك الموحّد، بس مالغياش. طلب المالك التصحيحي صريح: إلغاء الكيان المنفصل نفسه،
مش نقله. Slice 1 (`PricingModel.WORKER_RATE`) وSlice 2a (حجز مباشر بيتخطى المطابقة) هيتلغوا مع
باقي البنية (ADR-0031 Slice E) — مش أساس يُبنى عليه أكتر. راجع ADR-0031 لخطة الإلغاء الكاملة.
**التاريخ:** 2026-08-21
