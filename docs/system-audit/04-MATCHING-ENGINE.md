...
**دي مش «الفني عنده شغل نشط؟» — دي تلات شروط مستقلة، كلها على مستوى اليوم بتوقيت مصر.**

```mermaid
flowchart TD
    S[الطلب المرشّح] --> E{طوارئ؟}
    E -->|أيوه| E1{"الفني منشغل جسديًا دلوقتي؟<br/>(ENGAGED: في الطريق/وصل/شغال/مستني موافقة)"}
    E1 -->|أيوه| X[❌ تعارض]
    E1 -->|لأ — حتى لو accepted| OK[✅ مؤهّل]
    E -->|لأ| N1{"فيه طلب نشط<br/>في نفس يوم الطلب المرشّح<br/>(بتوقيت مصر)؟"}
    N1 -->|لأ| N3
    N1 -->|أيوه| N2{"تقاطع نافذة زمنية حقيقي؟<br/>أو اليوم = النهاردة والفني ENGAGED؟"}
    N2 -->|أيوه| X
    N2 -->|لأ| N3{"مجموع دقايق اليوم + المرشّح<br/>> daily_capacity_minutes؟"}
    N3 -->|أيوه| X
    N3 -->|لأ| OK
```
...
الفرق ده مقصود: **طلب اتقبل بس الفني لسه ما تحرّكش ليه ≠ الفني مشغول دلوقتي**.
...
كلها من `scheduling-scenarios.spec.ts` (١٠/١٠ عدّوا):
...
| **A2** | شغّال دلوقتي ١١:٠٠–١٤:٠٠ | نفس اليوم ٢٠:٠٠ | ❌ مرفوض | نفس اليوم + ENGAGED دلوقتي |
...
| **D2** | `in_progress` دلوقتي | طوارئ دلوقتي | ❌ مرفوض | منشغل جسديًا |
...
> **أيوه، يقدر.** مفيش أي منطق بيمنع ده. القيد الوحيد على الشغل النشط بيسري على **نفس اليوم** بس.

### إجابة أمثلة المالك بالظبط

فني عنده: `09:00–11:00` طلب ١، `13:00–15:00` طلب ٢ (كلهم النهاردة، وهو مش منشغل جسديًا دلوقتي):
...
> ⚠️ لو الفني **منشغل جسديًا دلوقتي** (`in_progress`)، كل طلبات النهاردة بتترفض — حتى ١٦:٠٠.
> ده الفرق بين A و A2 فوق.
