...
| `in_progress` (شغّال فعلاً دلوقتي) | ❌ مستبعد | D2 ✅ |
| `technician_on_way` (في الطريق) | ❌ مستبعد | — |
...
| البند | الوضع | التوصية |
|---|---|---|
| وزن المسافة للطوارئ = صفر | الطوارئ بتترتّب بالمستوى مش بالقرب | **قرار مالك**: للطوارئ القرب غالبًا أهم من المستوى. تشغيله = تغيير إعداد واحد |
| السقف اليومي مش بيسري على الطوارئ | فني عنده ١٢ ساعة محجوزة ممكن ياخد طوارئ | مقصود (الطوارئ استثناء) — بس يستاهل تأكيد |
